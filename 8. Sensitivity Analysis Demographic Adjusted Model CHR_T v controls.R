...
df_cc <- df_chr %>% subset(select = c(MIR132, MIR34A, MIR9, MIR941, MIR137, Age, Gender, Ethnicity, Group, Transition_status))
...
df_NAPLS_chr$PI_HC <- predict(final_full_model_chr, newx = as.matrix(df_NAPLS_chr[, c("MIR9_resid", "MIR34A_resid", "MIR132_resid", "MIR137_resid", "MIR941_resid")]), type = "link")[, 1]
