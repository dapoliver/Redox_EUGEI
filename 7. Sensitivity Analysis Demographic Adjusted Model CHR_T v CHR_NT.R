...
predictors <- list(
  a = c("MIR9_resid", "MIR34A_resid", "MIR132_resid", "MIR137_resid", "MIR941_resid")
)
...
df_NAPLS_chr$PI_CHR <- predict(final_full_model_chr, newx = as.matrix(df_NAPLS_chr[, c("MIR9_resid", "MIR34A_resid", "MIR132_resid", "MIR137_resid", "MIR941_resid")]), type = "link")[, 1]
...
write.csv(results_NAPLS, "external_validation_results_demo_171025.csv", row.names = FALSE)
...
write.csv(results_NAPLS_recal, "external_validation_results_demo_recal_171025.csv", row.names = FALSE)
