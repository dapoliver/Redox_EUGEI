...
write_csv(results_new, "CV_results_corr.csv")

write.csv(all_predictions, "predictions_output_corr_210225.csv", row.names = FALSE)

predictions_data <- read.csv("predictions_output_corr_210225.csv") # Read the predictions output file
